...
(cl:defmethod cl:initialize-instance :after ((m <robotencoder>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robotencoder)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ysrobotodom-msg:<robotencoder> is deprecated: use ysrobotodom-msg:robotencoder instead.")))

(cl:ensure-generic-function 'leftencoder-val :lambda-list '(m))
(cl:defmethod leftencoder-val ((m <robotencoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ysrobotodom-msg:leftencoder-val is deprecated.  Use ysrobotodom-msg:leftencoder instead.")
  (leftencoder m))

(cl:ensure-generic-function 'rightencoder-val :lambda-list '(m))
(cl:defmethod rightencoder-val ((m <robotencoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ysrobotodom-msg:rightencoder-val is deprecated.  Use ysrobotodom-msg:rightencoder instead.")
  (rightencoder m))

(cl:ensure-generic-function 'seq-val :lambda-list '(m))
(cl:defmethod seq-val ((m <robotencoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ysrobotodom-msg:seq-val is deprecated.  Use ysrobotodom-msg:seq instead.")
  (seq m))
